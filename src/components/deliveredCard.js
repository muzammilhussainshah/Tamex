        ...
        <View
            ...
            <View style={styles.listing}>
                ...
                <View style={{ flex: 9 }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={{ color: Colors.grey, marginLeft: 7, fontSize: 15 }}>Recipent Name</Text>
                        <Text style={{ marginLeft: 7, fontSize: 17, paddingHorizontal: 5, paddingVertical: 2 }}>{data.recipeint_Name}</Text>
                    </View>
                </View>
            </View>
            <View style={styles.listing}>
                ...
                <View style={{ flex: 9, }}>
                    <View style={{ flex: 1 }}>
                        <Text style={{ color: Colors.grey, marginLeft: 7, fontSize: 15 }}>COD</Text>
                        <Text style={{ marginLeft: 7, fontSize: 17, paddingHorizontal: 5, paddingVertical: 2 }}>{data.cordination}</Text>
                    </View>
                </View>
            </View>
        </View>
