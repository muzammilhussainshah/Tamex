    ...
    return (
        <View style={{ flex: 1, backgroundColor: Colors.bgColor }}>
            <View style={{ height: 70, }}>
                <AppHeader heading={"Faild"} rightIcon={true} rightIconText={"Cancle"} />
            </View>
            <View style={{ flex: 8, }}>
                <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
                    ...
                    <View style={styles.note}>
                        ...
                        <Entypo name="attachment" style={{ fontSize: 26, color: Colors.grey }} />
                    </View>
...
const styles = StyleSheet.create({
    ...
    container: { marginTop: 20, borderRadius: 15, width: "95%", marginHorizontal: "2.5%", justifyContent: 'center', alignItems: 'center', },
